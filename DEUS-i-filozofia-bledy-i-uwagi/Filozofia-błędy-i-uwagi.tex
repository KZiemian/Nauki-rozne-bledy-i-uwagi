...
\Work{ % Autorzy i tytuł dzieła
  H. Gene Blocker, Christopher L. Starling, ,,Filozofia japońska'',
  \cite{BlockerStarlingFilozofiaJaponska2008} }


% \CenterTB{Uwagi}

% \start \StrWg{5}{4} W~tej linii brakuje liczby 39, oznaczającej
% stronę na~której rozpoczyna~się wstęp.
