...
\Work{ % Autor i tytuł dzieła
  ...
  ,,Logika matematyczna'', \cite{QuineLogikaMatematyczna74} }
...
\start \Str{10} Należy uwzględnić dwa typy dowodu używające negacji. Pierwszy to~dowód przez \textbf{kontrapozycję}, opierający~się na~tożsamości
\begin{equation}
  \label{eq:1}
  ( \alpha \Ra \beta ) \equiv ( \neg \beta \Ra \neg \alpha).
\end{equation}
