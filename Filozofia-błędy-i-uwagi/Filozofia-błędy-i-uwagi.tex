...
\Work{ % Autor i tytuł dzieła
  ...
  \textit{i~dwa oblicza mesjanizmu}, \cite{HerbichPragnienieKrolestwa2018}}
...
\Work{ % Autor i tytuł dzieła
  Gottlob Frege \\
  \textit{Pisma semantyczne}, \cite{FregePismaSemantyczne1977}}
...
\begin{center}
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    & Od góry & Od dołu & & \\
    \hline
    XXI &  1 & & przypis 30 & przypis 31 \\
    XXV & &  8 & \raisebox{-0.2em}{j}ako & jako \\
    XXX &  3 & & „ $\vdash \, p$” & „$\vdash \, p$” \\
    4   & 11 & & $\vdash$ . & $\vdash$. \\
    12  & &  7 & stanowi własność & nie stanowi własności \\
    % &   & &  & \\
    %  & &  &  &  \\
...
\noindent
\StrWd{28}{2} Mowa jest tu o~symbolizacja mikroantropicznej, wydaje~się
...
\Work{ % Autor i tytuł dzieła
  Roger Scruton \\
  \textit{Zielona filozofia. Jak poważnie myśleć o naszej planecie},
...
\noindent
\StrWg{XV}{15} W~tej linii brakuje numeru przypisu. Numerem tym oczywiści
powinno być „1”.
...
\bibliography{DEUSBooks,PhilBooks}{}
