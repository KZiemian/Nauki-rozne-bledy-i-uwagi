...
\begin{center}
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    & Od góry & Od dołu & & \\
    \hline
    7 &  4 & & \emph{spoglądać{ } na} & \emph{spoglądać na} \\
    % & & & & \\
    % & & & & \\
    % & & & & \\
    % & & & & \\
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    & Od góry & Od dołu & & \\
    \hline
    403 & &  6 & \emph{Ally.} & \emph{Ally:} \\
    408 & &  8 & wespół & wespół~z \\
    412 & &  3 & \emph{Snows. A~History} & \emph{Snows: A~History} \\
    412 & &  3 & \emph{since} & \emph{Since} \\
    416 &  1 & & w przyczyn & z~przyczyn \\
    417 & &  2 & \emph{Generalissimo. Chiang}
           & \emph{The Generalissimo: Chiang} \\
    423 & &  2 & \emph{Enlai. The} & \emph{Enlai: The} \\
    425 &  7 & & Chin nowoczesnych & nowoczesnych Chin \\
    425 & &  4 & \emph{History} $^{ 2 }$ & \emph{History}$^{ 2 }$ \\
    425 & &  2 & \emph{History. The} & \emph{History: The} \\
...
\Powin \emph{Zarys historii gospodarczej XX~wieku}
...
% ####################################################################
% Bibliografia
\bibliographystyle{plalpha} \bibliography{HistoryBooks}{}
