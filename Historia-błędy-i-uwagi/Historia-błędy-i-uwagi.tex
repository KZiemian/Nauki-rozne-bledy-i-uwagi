...
\noindent
\StrWd{23}{4} Podane tu~stwierdzenie, że~Amerykanie w~1850~r.
...
\noindent
\StrWg{21}{1} Ponieważ książka ta został pierwotnie wydania w~1994 roku,
...
\noindent
\StrWg{70}{2} Nie wiem kto popełnił błąd, żołnierz, autor czy~tłumacz, ale
...
\noindent
\StrWd{70}{5} To zdanie jest na~pewno źle przetłumaczone, ale~nie~wiem
jakie je poprawić.
...
\noindent
\StrWd{102}{8} Nie potrafię zrozumieć co~w~tym kontekście miało znaczyć
zdanie „co~wyjątkowo miało~się okazać nieskuteczne”.
...
\noindent
\StrWd{125}{7} Należałoby podać, w~jakiej walucie~są wyrażone,
...
\noindent
\StrWg{150}{20} Zdanie „zbliża~się czas wielkich zawirowań~-- a~tym samym
konieczność określenia przez Związek Radziecki wynikających z~tego
...
\noindent
\StrWg{159}{20} Zdanie „pozwoli Niemcom gnić, dopóki owoce
...
\noindent
\StrWg{174}{18} Słowa Milovana Dżilasa warto byłoby opatrzyć komentarzem.
W~tym momencie ich brzmienie jest trochę dziwne, a~sens niepewny.
...
\noindent
\StrWg{197}{8} W~tym wierszu jest mowa o~przeżyciu przez Brytyjczyków
Pierwszej~Wojny Światowej, ale bardzo możliwe, że~jest to~błąd i~tak
naprawdę chodzi o~Drugą.
...
\noindent
\StrWg{258}{17} Z~kontekstu ciężko wywnioskować, kim było „dwóch lewicowych
członków ruchu oporu”. Ten fragment powinien być poprawiony.
...
\noindent
\StrWd{282}{3} Na~końcu książki nie ma odniesienia do przypisu z~tej linii.
...
\noindent
\StrWd{417}{19--18} O~Luckym Luku, czyli na polski Mającym Szczęście
...
\noindent
\StrWg{513}{7} W~1970 roku protesty o~szczególnych konsekwencjach miały
miejsce w~Szczecinie, nie można więc ich ograniczać tylko do Gdańska.
...
\noindent
\StrWg{526}{14} Wydaje mi~się, że rozumiem sens zdania o~optymistycznym
zapatrzeniu w~postindustrialne wyobcowanie i~bezduszność, ale według mnie
nie powinno~się pisać w~taki przewrotny i~skomplikowany sposób, aby
czytelnik nie zgubił~się.
...
\noindent
\StrWg{556}{8} Nie rozumiem co miały znaczyć słowa „dla~obojętnych skrajów
ruchu robotniczego”.
...
\noindent
\StrWd{585}{18} Panków to dzielnica Berlina, gdzie w~początkowym okresie
istnienia NRD~znajdowały się rezydencje władz tego kraju.
...
\noindent
\StrWg{602}{13} Na~końcu książki nie ma odniesienia do przypisu z~tej linii.
...
\noindent
\StrWd{655}{16--14} Zdanie „przeczyć fundamentalnemu powinowactwu
...
\noindent
\StrWd{681}{4--3} Nie rozumiem co miało dokładnie znaczyć zdanie „Epoka
zastoju Leonida Breżniewa (Michaił Gorbaczow) żywiła~się wieloma
złudzeniami”.
...
\noindent
\StrWd{681}{2} W~Polsce przyjęła~się pisonia tego nazwiska „Potiomkin” nie
jak w~krajach anglojęzycznych „Potemkin”.
...
\noindent
\StrWd{693}{16} Na~końcu książki nie ma odniesienia do przypisu z~tej linii.
...
\noindent
\StrWd{703}{18} Słowo „niezrównany” brzmi trochę dziwnie w~tym kontekście.
Może powinno być „nierówny”.
...
\noindent
\StrWd{718}{2} Zwrot „bezwarunkowe niezrozumienie” jest dziwny i~ciężki do
...
\noindent
\StrWd{734}{19} NRD pojawia~się w~tym wersie dość niespodziewanie, może
chodziło o~Czechosłowację?
...
\noindent
\StrWd{742}{10} Na~końcu książki nie ma odniesienia do przypisu z~tej linii.
...
\noindent
\StrWd{757}{6--5} Zdanie „którego rządzący byli komunistycznymi satrapami,
...
\noindent
\StrWd{782}{15} Powinno tu być wyjaśnione czym~są prawa ciągnięcia.
...
\noindent
\StrWd{805}{9} Na~końcu książki nie ma odniesienia do przypisu z~tej linii.
...
\noindent
\StrWd{823}{12-10} Zdanie „W~kraju było teraz więcej osób mówiących
...
\noindent
\StrWg{46}{3} Jest tu podana ilość mieszkańców Tokio w~1720~r., ale~do
...
\noindent
\StrWg{85}{10} Nie jest napisane kim jest ten potężny reformator i~wróg
cudzoziemców.
...
\noindent
\StrWd{134}{13--11} Nie jest wyjaśnione która grupa z~wymienionych grup
odziedziczyła z~okresu Tokugawów zachowania ksenofobiczne.
...
\noindent
\StrWd{424}{11} Zgodnie z~tym co było napisane na~stronie~417 kobieta ta
raczej nie fałszowała banknotów, lecz~potwierdzenia depozytu z~lokalnej
agencji kredytowej.
...
\noindent
\StrWg{425}{5} W~tym miejscu jest mowa o~sytuacji gospodarczej Japonii
na przełomie lat osiemdziesiątych i~dziewięćdziesiątych~XX wieku, należy
...
\noindent
\StrWd{48}{11} Nie rozumiem, czemu zatopienie przez japońskie
...
\noindent
\StrWd{100}{21} „Jan Baptysta” to po polsku „Jan Chrzciciel”.
...
\noindent
\StrWd{9}{6} Zamieszczony tu komentarz odnośnie słowa „lustracja”, które ma
...
\noindent
\StrWg{989}{14--15} Według mnie tekst „zapobiec degeneracji wolności
