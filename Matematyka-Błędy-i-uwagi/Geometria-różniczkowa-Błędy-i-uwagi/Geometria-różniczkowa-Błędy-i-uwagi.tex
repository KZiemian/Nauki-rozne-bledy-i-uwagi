...
\noindent
\StrWierszDol{233}{3} Zamiast $dy/dx$ powinno być $d g( x )/dx$.
...
\noindent
\StrWierszeGora{21}{12, 13} Wiersze te zostały bardzo brzydko sformatowane.
...
\noindent
\StrWierszDol{32}{13} Nie mam pojęcia o~co chodzi w~stwierdzeniu
„gdzie $n = \dim \Kbb^{ n }$”.
...
\noindent
\StrWierszDol{33}{10} W~niewinnie wyglądającym wzorze $\left(
...
\noindent
\StrWierszDol{33}{5} Podany tu wzór $\dim Y^{ \perp } = n - 2$ jest niewątpliwie
...
\noindent
\StrWierszeGora{34}{7--8} Znajdujące~się tu zdanie „Formę mającą postać
...
\noindent
\StrWierszeDol{34}{1--3} Znajdujemy tu informację, że~$n$-tą zespoloną
...
\noindent
\StrWierszGora{34}{8} Aby definicja przestrzeni $\spFrak( n, \Kbb )$ była
