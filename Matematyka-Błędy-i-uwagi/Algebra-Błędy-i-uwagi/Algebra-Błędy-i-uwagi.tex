...
\addbibresource{Algebra-Bibliography.bib}
...
% ------------------------------------------------------
% Local packages
% You need to put them in directory Local-packages
% ------------------------------------------------------
...
\begin{center}
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \hline
    \hphantom{0}28 & & 13 & $x \neq 0$ & $x \neq y$ \\
    \hphantom{0}34 & & 12 & $x ( y y^{ -1 } x^{ -1 }$
    & $x ( y y^{ -1 } ) x^{ -1 }$ \\
    \hphantom{0}53 & \hphantom{0}6 & & $\Real( ( \eta \eta' ) \eta'' ) )$
