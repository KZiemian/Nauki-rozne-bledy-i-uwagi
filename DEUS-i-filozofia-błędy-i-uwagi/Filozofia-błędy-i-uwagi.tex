...
\start \Str{3} Tytuł książki „Mądrość świata” nie wydrukowała~się
...
\start \Str{1 i~3} Marginesy tych stron są za małe, tak że tytuł książki
...
\begin{center}
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    %  & & & więc na & więc \\
    %  & &  & Neuf & Les Neuf \\
    %  & &  & x$\rho\iota\tau\iota\chi\acute{\eta}$ & $\chi\rho\iota\tau\iota\chi\acute{\eta}$ \\
    %  & & & z~której & w~której \\
    %  & &  & wladcy & władcy \\
    \hline
  \end{tabular}
...
\start \Str{673} Zamiast liczb całkowitych~$\Zbb$ należałoby całą
...
\start \Str{718} Rysunek A-26 (b) jest narysowany błędnie.
...
\start \Str{747} Pojęcie \textbf{funkcji holomorficznej} zdaje~się tu
