...
rzeczywistych. W~pierwszym rzędzie zbadamy własność analogiczną do
łączności mnożenia liczb rzeczywistych.
\begin{equation}
...
$v_{ \HorSpaceOne 3 } \in V_{ u_{ \HorSpaceOne 3 } }$. Główny problem z~tą
  ...
  \begin{equation}
    ...
    \begin{split}
      ...
      &=
        ...
        \alpha \HorSpaceOne e_{ \HorSpaceTwo u_{ \HorSpaceOne 1 } },
        \beta \HorSpaceOne e_{ \HorSpaceTwo u_{ \HorSpaceOne 2 } } ),
        \gamma \HorSpaceOne e_{ \HorSpaceTwo u_{ \HorSpaceOne 3 } } \big) = \\
      &=
