...
\noindent
\Str{10} Ciągłe używane notacji Diraca, które zaczyna~się
...
% \noindent
% \Str{4} Związek między omawianymi na tej stronie równaniami (1.4) i~(1.5) można wyjaśnić w~następujący sposób. Sama postać (1.4)~sugeruje, że~należy rozpatrzyć następujące równanie
% \begin{equation}
...
% $\sgn\ten{( \La_{ 1 } \La_{ 2 } )}{^{ 0 }_{ 0 }}$ dla iloczynu dwóch
% transformacji Lorentza.
