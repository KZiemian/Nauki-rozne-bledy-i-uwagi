...
<<<<<<< HEAD:Matematyka-błędy-i-uwagi/Równania-różniczkowe-zwyczajne-błędy-i-uwagi/Matwiejew-Metody-całkowania-równań-różniczkowy-zwyczajnych.tex
...
=======
    ...
    % & & & & \\
    % & & & & \\
>>>>>>> WprowadzenieDoAlgorytmow:Matematyka-błędy-i-uwagi/Równania-różniczkowe-błędy-i-uwagi/Równania-różniczkowe-zwyczajne-błędy-i-uwagi.tex
    % & & & & \\
    \hline
  \end{tabular}
