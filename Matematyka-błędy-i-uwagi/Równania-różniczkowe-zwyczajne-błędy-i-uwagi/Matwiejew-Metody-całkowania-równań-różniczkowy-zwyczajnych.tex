...
$F\big( x, y( x ), y'( x ), \ldots, y^{ ( n ) }( x ) \big) = 0$.”. Zwykle stosować będziemy skrót myślowy „Dana jest funkcja
...
staje~się dobrze określoną funkcją. Zasady te uzasadniają, czemu
...
Jeżeli mamy już daną funkcję $F$ z~określoną dziedziną i~przeciwdziedziną, która definiuje równanie różniczkowe
\begin{equation}
