...
\start \Str{10} Dowód drugiej części twierdzenia 1.2.2 byłby bardziej zrozumiały, gdyby wzór przedstawiający działania kanonicznego homomorfizmu zapisać jako
\begin{equation}
...
\Powin \textit{generatorów i~jest równa $S \setminus S^{ 2 }$}. \\
