...
elementem z~dwoma różnymi rozkładami, który ma najmilejszą długość w~$M$.
...
$k > 1$, $l > 1$. Ponadto bez ograniczania ogólności możemy przyjąć,
...
z~dwóch możliwości. Albo $c_{ i_{ 1 } } = c_{ j_{ 1 } } u$,
$u ( c_{ i_{ 2 } } c_{ i_{ 3 } } \ldots c_{ i_{ p } } ) =
c_{ j_{ 2 } } c_{ j_{ 3 } } \ldots c_{ j_{ q } }$ albo ????.
