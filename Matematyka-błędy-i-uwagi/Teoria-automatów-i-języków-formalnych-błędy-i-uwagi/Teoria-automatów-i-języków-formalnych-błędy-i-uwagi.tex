...
bo~$S \setminus S^{ 2 } = \{ a^{ 2 }, a^{ 3 } \}$, zaś rozkład na elementy $a^{ 2 }$ i~$a^{ 3 }$ nie jest jednoznaczny. Przykładowo
\begin{equation}
  \label{eq:Forys-Forys-???}
...
\start Twierdzenie 1.2.6 powinno być dalej prawdą, gdy zamiast skończonej
