...
wykonana, bo zgodnie z~twierdzeniem \eqref{thm:Forys-Forys-01} $S$ jest
...
\begin{equation}
  ...
  a b = c d.
\end{equation}
Z~definicji wolnego monoidu językowego wynika, że~możemy przedstawić te elementy jako
\begin{subequations}
  \begin{align}
    a &= b_{ a,\, 1 } b_{ a,\, 2 } \ldots b_{ a,\, n_{ 1 } }, \\
  \end{align}
\end{subequations}
gdzie wszystkie $b_{ a,\, i }$, $b_{ b,\, j }$, $c_{ c,\, k }$, $d_{ d,\, l }$ należą do bazy $B$ wolnego monoidu językowego $M$.
