...
Na koniec zauważmy, że~jeśli $A = \{ 1 \}$ to wówczas $A^{ * }$ jest
kanonicznie izomorficzny z~$M$.

\vspace{\spaceFour}



\start \Str{10} W~dowodzie twierdzenia 1.2.2 użyte jest mowa o~„długości elementu $m \in M$ w~$B^{ * }$”.
