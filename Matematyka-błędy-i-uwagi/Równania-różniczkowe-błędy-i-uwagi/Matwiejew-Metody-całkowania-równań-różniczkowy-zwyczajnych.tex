...
rozwiązywania takich równań lub też będzie wolne od~pewnych nieprzyjemnych
własności, które mogą wystąpić w~ogólniejszym przypadku. Z~tych samych
...
Niech $A \subset \Rbb$ i~rozważmy funkcję $y : A \to \Rbb$. W~niniejszej książce
naszym podstawowym wymogiem jest to, by w~każdym punkcie dziedziny $A$
istniała
