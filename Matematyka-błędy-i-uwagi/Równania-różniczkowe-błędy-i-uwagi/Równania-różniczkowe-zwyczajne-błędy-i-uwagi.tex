...
Przykład~1 ze strony~17, pokazuje że~w~przypadku równania
\begin{equation}
  \label{eq:Matwiejew-Metody-calkowania-ETC-55}
  y'( x ) = 2 x,
\end{equation}
żadna z~jego izoklin nie jest jego rozwiązaniem.
...
{\Large Od strony 19 należy zacząć ponowne czytanie książki.}
...
% $| x - x_{ 0 } | \leq h_{ 1 } \leq h$ które nie byłoby równe
% rozwiązaniu $y = y( x )$ w~każdym punkcie przedziału
% $\absOne{ x - x_{ 0 } } \leq h_{ 1 }$. \\
