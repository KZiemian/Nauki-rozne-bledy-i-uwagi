...
\Work{ % Autor i tytuł dzieła
  Dariusz Karłowisz \\
  \textit{Arcyparadoks śmierci. Męczeństwo jako kategoria filozoficzna~--
  pytanie o~dowodową wartość męczeństwa},
...
\noindent
\StrWg{20}{1--2} Nie rozumiem czemu w~tym wierszach pisze~się o~„bardziej
...
\noindent
\StrWg{310}{5} Użyte tu obraźliwe słowo „lewactwo” tak nie pasuje do stylu
...
\noindent
\StrWg{331}{1} Zdanie „Idea \textit{socjalizmu chrześcijańskiego}
...
\noindent
\StrWd{439}{2} Po ostatnim słowie greckim powinien być zamykający
...
\noindent
\StrWg{440}{1} Poza ostatnim słowem, ta linie jest powtórzenie tekstu
...
\noindent
\StrWd{452}{5} W~tej linii odstępy między wyrazami~są zbyt duże.
...
\noindent
\StrWd{493}{7} W~tej linii odstępy między wyrazami~są zbyt duże.
...
\noindent
\StrWd{496}{4} Ponownie, użyte tu obraźliwe słowo „lewactwo” tak nie pasuje
...
\noindent
\StrWd{513}{7} W~tej linii odstępy między wyrazami~są zbyt duże.
...
\noindent
\StrWd{80}{5--4} Czy chodzi tu o~to, że~po ogołoceniu z~religii życie
...
\noindent
\StrWd{99}{7} Zdanie „Wytrwanie w~miłości do~innego człowieka w~stanie
...
\Work{ % Autor i tytuł dzieła
  Jacques Maritain \\
  \textit{Wieśniak znad Garonny. Stary świecki chrześcijanin snuje
