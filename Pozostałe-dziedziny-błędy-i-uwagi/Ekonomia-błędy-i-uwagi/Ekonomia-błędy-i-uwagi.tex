...
\Work{ % Autor i tytuł dzieła
  Adam Smith \\
  „Badania nad naturą i~przyczynami bogactw narodów. Tom~I”,
  \cite{} }
...
\Work{ % Autor i tytuł dzieła
  ...
  „Etyka produkcji pieniądza”, \cite{HulsmannEtykaProdukcjiPieniadza2014} }
...
\StrWg{4}{9--10} Może wydawać~się dziwne, że w tym kontekście wymienione jest ósme przykazanie\footnote{Używany jest tu katolicki podział Dekalogu.}. Może to być błąd, możliwe też, że~H\"{u}lsmann miał tu na myśli związek jak ma to przykazanie z~kwestią produkcji pieniądza, co omówił na stronie 23 niniejszej książki
